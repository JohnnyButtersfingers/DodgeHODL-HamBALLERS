...
```
┌─────────────────────────────────────────────────────────────────┐
│ XPVerifier Contract - Abstract Explorer                         │
├─────────────────────────────────────────────────────────────────┤
│ Address: 0x742d35Cc6634C0532925a3b844Bc9e7595f6E123           │
│ Network: Abstract Testnet (Chain ID: 11124)                    │
│ Balance: 0.5 ETH                                               │
...
```
┌─────────────────────────────────────────────────────────────────┐
│ Read Contract - XPVerifier                                      │
├─────────────────────────────────────────────────────────────────┤
│ 1. xpThreshold() → 50                                          │
│ 2. verifier() → 0x0x8626f6940E2eb28930eFb4CeF49B2d1F2C9C1199  │
│ 3. isNullifierUsed(bytes32) → bool                            │
│ 4. owner() → 0xdAc1428c8268Cb2A8692d9c88d96878C6B9F0388       │
│ 5. totalVerifications() → 1847                                 │
└─────────────────────────────────────────────────────────────────┘
```
...
```
┌─────────────────────────────────────────────────────────────────┐
│ Write Contract - XPVerifier                                     │
├─────────────────────────────────────────────────────────────────┤
│ 1. verifyXPProof(proof, publicSignals)                         │
│    - Gas Estimate: 287,456                                     │
│    - Last Called: 2 minutes ago                               │
│                                                                │
│ 2. setThreshold(uint256 _threshold)                           │
│    - Gas Estimate: 44,567                                      │
│    - Access: Owner Only                                        │
│                                                                │
│ 3. updateVerifier(address _verifier)                          │
│    - Gas Estimate: 46,234                                      │
│    - Access: Owner Only                                        │
└─────────────────────────────────────────────────────────────────┘
```
...
```
┌─────────────────────────────────────────────────────────────────┐
│ Recent Transactions - XPVerifier                                │
├────────────┬──────────────┬─────────────┬──────────┬──────────┤
│ Txn Hash   │ Method       │ From        │ Gas Used │ Status   │
├────────────┼──────────────┼─────────────┼──────────┼──────────┤
│ 0x1a2b...  │ verifyXPProof│ 0x9f8c...  │ 285,123  │ ✅ Success│
│ 0x3c4d...  │ verifyXPProof│ 0x7e6a...  │ 287,456  │ ✅ Success│
│ 0x5e6f...  │ verifyXPProof│ 0x2d3b...  │ 286,789  │ ✅ Success│
│ 0x7g8h...  │ setThreshold │ 0xdAc1...  │ 44,567   │ ✅ Success│
│ 0x9i0j...  │ verifyXPProof│ 0x4c5a...  │ 288,234  │ ✅ Success│
└────────────┴──────────────┴─────────────┴──────────┴──────────┘
```
...
```
┌─────────────────────────────────────────────────────────────────┐
│ Contract Events - Last 100 Blocks                              │
├─────────────────────────────────────────────────────────────────┤
│ Event: ProofVerified                                           │
│   - User: 0x9f8c6940E2eb28930eFb4CeF49B2d1F2C9C1199          │
│   - XP Amount: 75                                              │
