...
// Configure axios with timeout for all HTTP requests
const axios = require('axios');
axios.defaults.timeout = 60000; // 60s timeout as specified
...
console.log('✅ Axios configured with 60s timeout and retry logic');
